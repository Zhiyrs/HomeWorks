...
public class Fish{
    ...
    public Fish (String petsTypes,String name,String color,int age,double weight){
        setPets (petsTypes, name, color,age, weight);
    }

    public void setPets(String petsTypes, String name, String color, int age, double weight){
